...
while True:
    action = input("\nWhat would you like to do? (print/append/pop/pop_first/prepend/get/quit): ").lower()
    ...
    if action == "quit":
        ...
        print("Invalid action. Please choose print, append, pop, pop_first, get, prepend, or quit.")
