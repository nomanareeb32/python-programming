...
while True:
    action = input("\nWhat would you like to do? (append/pop/prepend/pop_first/print_list/get/set_value/quit): ").lower()
    ...
    if action == "quit":
        ...
        print("Invalid action. Please choose append, pop, prepend, pop_first, print_list, get, set_value, or quit.")