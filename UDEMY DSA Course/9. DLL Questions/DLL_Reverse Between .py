...
while True:
    action = input("\nWhat would you like to do? (print/append/pop/pop_first/prepend/get/set/insert/remove/reverse/check_palindrome/partition/reverse_between/quit): ").lower()
    ...
    if action == "quit":
        ...
        print("Invalid action. Please choose print, append, pop, pop_first, prepend, get, set, insert, remove, reverse, check_palindrome, partition, reverse_between, or quit.")